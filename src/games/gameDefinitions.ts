...
const definitions: Definition[] = [
  ...
  },
  {
    ...
    fullDescription: '화면 어디서든 새총처럼 뒤로 당겨 도끼를 반대 방향으로 던집니다. 날이 바위나 나무에 올바른 각도와 속도로 닿으면 박히고, 빛나는 연결선이 몸을 물리적으로 끌어올립니다. 금속·수정·얼음·가시 바위에는 박히지 않습니다. 떨어져도 죽지 않으며 아래 지형에 자연스럽게 걸린 곳에서 즉시 다시 도전합니다.',
    ...
    controls: [{ label: '화면 어디서든 당기기', description: '공이나 캐릭터를 직접 잡을 필요 없이 화면 아무 곳에서나 원하는 발사 방향의 반대로 당깁니다.' }, { label: '놓기', description: '아래로 당기면 위로, 오른쪽으로 당기면 왼쪽으로 도끼가 날아갑니다. 당긴 거리가 힘을 결정하며 18px보다 짧으면 취소됩니다.' }, { label: '세이브 던지기', description: '흔들리거나 빠르게 추락하는 중에도 새 도끼를 던져 아래쪽 암벽을 잡을 수 있습니다.' }],
