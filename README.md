...
[![Play Flicko](https://img.shields.io/badge/PLAY_FLICKO-지금_플레이하기-ff2d78?style=for-the-badge&labelColor=121218)](https://rudwndgus.github.io/Flicko/)
...
<table>
  <tr>
    <td width="25%"><img src="./docs/images/flicko-feed.png" alt="Flicko 세로형 게임 피드"></td>
    <td width="25%"><img src="./docs/images/neon-vault.png" alt="Flicko Originals Neon Vault"></td>
    <td width="25%"><img src="./docs/images/perfect-stack.png" alt="Flicko Originals Perfect Stack"></td>
    <td width="25%"><img src="./docs/images/pin-core.png" alt="Flicko Originals Pin Core"></td>
  </tr>
  <tr align="center">
...
현재 Flicko는 이 발견 방식을 검증하기 위한 모바일 PWA 프로토타입입니다. 한 손으로 빠르게 이해하고 반복해서 도전할 수 있는 9개의 **Flicko Originals**를 실제 플레이 가능한 피드로 제공합니다.

프로토타입에는 게임을 중심으로 연결되는 SNS 흐름도 함께 구현되어 있습니다. 홈의 스토리·플레이 기록 게시물, 기존 플레이어블 탐색 피드, DM 미리보기, 로컬 기록 기반 프로필을 하단 4개 탭에서 오갈 수 있습니다. 탐색과 플레이는 익명으로 열어 두고, 계정이 필요한 행동에서만 로그인으로 이어지는 구조입니다.
...
백엔드 연결은 [집에서 실행할 Supabase 구현 프롬프트](./docs/Flicko_Supabase_Backend_Handoff_Prompt.md)에 재현 가능한 DB 마이그레이션, RLS, Auth, Realtime, Storage 요구사항으로 정리되어 있습니다.
